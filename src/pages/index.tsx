          ...
          <main className="px-6 md:px-12 lg:px-24 xl:px-36 py-0 my-0 mx-auto max-w-[1600px]">
            <section className="flex flex-col justify-center min-h-screen max-w-5xl mx-auto my-0">
              ...
              <p className="text-gray-300 text-xl mt-4 mx-4">
                I am software engineer with a passion for <span className="text-pink-400">web development</span>. <br />
                Currently studying Computer Science in Engineering at <br /><span className="text-pink-400">AGH University of Science and Technology</span>.
              </p>

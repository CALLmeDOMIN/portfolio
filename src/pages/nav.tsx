...
export default function Nav() {
	return (
		<nav className="w-screen flex items-center justify-between gap-8 p-4 px-10 h-1/3 bg-slate-900">
			<Link href={'#home'}><Image src={"/logo.png"} alt="Logo" height={48} width={48}></Image></Link >

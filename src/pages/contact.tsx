...
export default function Contact() {
	...
	return (
		<section ref={ref} id="contact" className={`flex flex-col space-y-4 min-h-[800px] py-28 mx-auto my-0 max-w-5xl  md:pr-10 text-gray-300 w-full opacity-0 transition-all translate-x-full duration-[1250ms] ${inView ? 'opacity-100 blur-none -translate-x-0' : ''}`}>

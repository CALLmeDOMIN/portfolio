	...
	return (
		<>
			<section
				ref={ref}
				id="about"
				className={`min-h-[600px] max-w-5xl mx-auto my-0 md:pr-10 py-28 opacity-0 -translate-x-full transition-all duration-[1250ms] ${inView ? 'opacity-100 translate-x-0 blur-none' : 'opacity-0'}`}
			>
